...
import type { ElementOf, OmitFrom } from './utils';
...
export const postgrestExtensions = {
    ...
    query: {
        ...
        >(
            ...
            builder as OmitFrom<PostgrestQueryBuilder<ClientOptions, Schema, Relation, RelationName, Relationships>, 'select' | 'delete'>,
            {
                /**
    ...
    filter: {
        ...
        >(
            ...
            builder as OmitFrom<PostgrestFilterBuilder<ClientOptions, Schema, Row, Result, RelationName, Relationships, Method>, 'filter'>,
            {
                 ...
                 */
                filter: <K extends string = string>(node: FilterNode<K>) => postgrestExtensions.filter.enable(
                    (
                        () => {
                            function applyFilterNode(
                                ...
                                if (node.type === 'logical') {
                                    ...
                                    // postgrest-js does not support nested 'and', so we need to use 'or' and negate the filters accordingly
                            ...
                            return applyFilterNode(builder, node);
                        }
                    )(),
                    context,
                ),
